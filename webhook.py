...
用于接收和处理GitHub仓库的push和pull request事件，提取并显示详细信息。
"""
...
def run_server(server_port=5000):
    """运行webhook服务器"""
    server_address = ('', server_port)
    httpd = http.server.HTTPServer(server_address, WebhookHandler)
    print(f"Webhook服务器启动在端口 {server_port}...")
    print(f"Webhook端点: http://localhost:{server_port}/webhook")
